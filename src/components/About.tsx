import { Box, Heading, Text, Stack, Badge, Link, Container, Divider, HStack, Icon, VStack, SimpleGrid } from '@chakra-ui/react'
import { User, Heart, Palette, Sparkles, Code, Globe, Award } from 'lucide-react'
